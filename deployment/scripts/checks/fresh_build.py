...
def import_check_wheel(python: Path, wheel: Path) -> None:
    ...
    code = (
        "import crime_research_kit._runtime.cli; import crime_research_kit._runtime.core.lanes.registry; import crime_research_kit._runtime.pipeline.app.service; "
        "import crime_research_kit._runtime.adapters.interfaces.mcp.server; import crime_research_kit.sdk; "
        "import crime_research_kit.sdk.examples"
    )
