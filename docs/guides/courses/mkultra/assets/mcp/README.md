...
| `mcp-05-save-staged-packet.png` | `save_extraction_packet` result, before canonical import. |
| `mcp-06-import-gate.png` | `import_extraction` requiring explicit `confirm=true`. |

Redact all host-specific MCP configuration paths outside the repo.
