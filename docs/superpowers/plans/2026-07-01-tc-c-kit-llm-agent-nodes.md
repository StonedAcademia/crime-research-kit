...
- Repo root: `/home/jdean/Documents/programming/true-crime-research/tc-c-kit`. All paths relative to it. Run tests with `cd <repo root> && .venv/bin/python -m pytest <path> -v` (baseline after Phase 2: 110 passed).
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_ops_source_text.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_ops_source_text.py tests/test_case_builder_structure.py -v`
Expected: PASS
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_provider.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_provider.py tests/test_case_builder_structure.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_packet_agent.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_packet_agent.py tests/test_case_builder_structure.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_helpers.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_helpers.py tests/test_case_builder_structure.py -v`
Expected: PASS
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_nodes.py -v`
...
Run: `cd /home/jdean/Documents/programming/true-crime-research/tc-c-kit && .venv/bin/python -m pytest tests/test_llm_nodes.py tests/test_pipeline_runner.py tests/test_case_builder.py tests/test_langgraph_resume.py -v`
