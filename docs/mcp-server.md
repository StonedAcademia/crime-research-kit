...
`/home/jdean/Documents/programming/true-crime-research/tc-c-kit/.venv/bin/trcr-mcp`
...
`plan_public_records` accepts public-record lane IDs from `docs/lanes.json`.
