...
from crime_research_kit._runtime.core.models.reports import ReportPage, SvgDoc, TableBlock

from crime_research_kit._runtime.adapters.ops.evidence.reports.analysis.pages.render import filter_terms
from crime_research_kit._runtime.adapters.ops.evidence.reports.analysis.svg.facets import (
    build_bipartite_figure,
    build_boundary_overlay_figure,
    build_path_atlas_figure,
    build_swimlanes_figure,
    build_treemap_figure,
)
from crime_research_kit._runtime.adapters.ops.evidence.reports.analysis.svg.matrix import (
...
from crime_research_kit._runtime.adapters.ops.evidence.reports.analysis.svg.network.layers import (
...
def build_analysis_chart_specs(chart_data: dict[str, Any]) -> list[ReportPage]:
    return sorted([
        ...
        _page(
            ...
            build_path_atlas_figure(chart_data["path_atlas"]),
        ...
        _page(
            ...
            build_boundary_overlay_figure(chart_data["boundary_rows"]),
        ...
        _page(
            ...
            build_swimlanes_figure(chart_data["swimlanes"]),
        ...
        _page(
            ...
            build_treemap_figure(chart_data["relation_type_counts"]),
        ...
        _page(
            ...
            build_bipartite_figure(chart_data["person_source_nodes"], chart_data["person_source"]),
