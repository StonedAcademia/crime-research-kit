"""Generate lane reference markdown from docs/lanes.json."""
...
MARKER = "<!-- Generated from docs/lanes.json; edit the registry, not this table. -->"
...
def generated_paths(repo_root: Path | None = None) -> dict[Path, str]:
    ...
    registry = load_lanes(root / "docs" / "lanes.json")
    return {
