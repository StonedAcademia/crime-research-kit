...
from case_builder.pipeline.graph.runner import build_case_builder_graph, langgraph_available, run_sequential
...
def _model_factory(llm_enabled: bool):
    if not llm_enabled:
        return None
    from case_builder.adapters.interfaces.llm.provider import get_chat_model
